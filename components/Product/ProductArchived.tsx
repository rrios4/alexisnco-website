                        ...
                        <ProductDetailsDialog product={product}>
                            <div className='p-4 m-2 rounded-lg cursor-pointer'>
                                <div className='relative w-full h-[250px] rounded-lg mb-4'>
                                    <Image className='rounded-lg object-cover hover:p-[-10px]' src={`https:${product.fields.image_cover_url.fields.file.url}`} priority sizes='' alt={product.fields.alt} fill />
